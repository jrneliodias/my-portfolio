...
export const projectDataPt: ProjectData = [
  {
    ...
    resume:
      "SPA de backoffice financeiro desenvolvida em React 19, TypeScript e Vite para gestão de cobranças, inadimplência, comissões, recebíveis, webhooks e relatórios automatizados. Arquitetura por domínio com TanStack Query, React Hook Form, Zod, RBAC, white-label multi-domínio e deploy via Jenkins/Firebase.",
    text: [
      {
  ...
  {
    title: "MAPFREPAY CHECKOUT — INTERFACE DE PAGAMENTO MAPFRE",
    image: ["/mapfrepay-1.png", "/mapfrepay-2.png", "/mapfrepay-3.png", "/mapfrepay-4.png", "/mapfrepay-5.png"],
    link: {},
    resume:
      "Interface de pagamento da MAPFRE, uma das maiores seguradoras do Brasil. Aplicação web responsiva, segura e multi-método que processa pagamentos por cartão de crédito, PIX, boleto, débito automático e BolePix — com suporte a assinaturas recorrentes e troca de forma de pagamento. Construído como white-label em React 19, Vite e TypeScript strict.",
    text: [
      {
        p: "O MapfrePay Checkout é o produto que o cliente final vê ao pagar um seguro da MAPFRE. A mesma base de código serve múltiplos contextos de produto via token de sessão, adaptando fluxo, validação e UX para cinco métodos de pagamento distintos.",
      },
      { h2: "O que foi entregue:" },
      {
        ul: [
