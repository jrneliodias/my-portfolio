...
export default async function Hero() {
  ...
  return (
    <section
      id="Hero"
      className="flex flex-col items-center px-2 py-10 lg:px-20 bg-background min-h-screen text-slate-900 dark:text-white"
    >
      <div className="flex flex-col-reverse gap-5 justify-center lg:flex-row items-center lg:w-5/6 lg:gap-10 flex-1">
        <div className="flex flex-col z-20 gap-3 w-5/6 lg:w-3/5 items-start lg:flex-1 animate-fade-right animate-ease-in-out">
          ...
          <p className="text-xl lg:text-2xl text-slate-700 dark:text-slate-200 font-medium">
            {t("role")}
          </p>
